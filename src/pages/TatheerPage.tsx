...
import TatheerTab from "@/components/calculators/TatheerTab";

export default function TatheerPage() {
      ...
      <div className="container relative z-10 mx-auto max-w-3xl">
        <div className="mb-6 text-center">
          ...
          <p className="mt-3 text-muted-foreground">
            Purify your investment income from non-compliant business activities
          </p>
        </div>
        ...
        <TatheerTab onAmountChange={handleAmountChange} />

        {/* Charity Section — shown when amount > 0 */}
        {activeAmount > 0 && (
          <CharitySection activeTab="tatheer" amount={activeAmount} />
        )}
      </div>
    </main>
  );
